...
function diagram(kind) { const diagrams = {
  ...
  generictypes:`<svg viewBox="0 0 180 120" role="img" aria-labelledby="d47t d47d"><title id="d47t">Generic type parameters filled at use sites</title><desc id="d47d">List T becomes List ClockEntry, Dictionary key value becomes Dictionary int Employee, and Task result becomes Task nullable ClockEntry.</desc><rect x="4" y="10" width="53" height="27" rx="6"/><rect x="64" y="10" width="53" height="27" rx="6"/><rect x="124" y="10" width="52" height="27" rx="6"/><path d="M30 38v20M90 38v20M150 38v20"/><rect x="4" y="59" width="53" height="45" rx="6"/><rect x="64" y="59" width="53" height="45" rx="6"/><rect x="124" y="59" width="52" height="45" rx="6"/><text x="30" y="28">List&lt;T&gt;</text><text x="90" y="22">Dictionary</text><text x="90" y="33">&lt;K,V&gt;</text><text x="150" y="28">Task&lt;T&gt;</text><text x="30" y="78">List</text><text x="30" y="92">ClockEntry</text><text x="90" y="76">int →</text><text x="90" y="91">Employee</text><text x="150" y="78">Task</text><text x="150" y="92">ClockEntry?</text></svg>`,
  genericinference:`<svg viewBox="0 0 180 120" role="img" aria-labelledby="d48t d48d"><title id="d48t">Argument types drive generic inference</title><desc id="d48d">Two DateTime arguments enter Later T, the compiler infers T as DateTime, and a DateTime result returns.</desc><rect x="5" y="24" width="48" height="28" rx="6"/><rect x="5" y="68" width="48" height="28" rx="6"/><rect x="70" y="37" width="55" height="46" rx="7"/><rect x="142" y="45" width="34" height="30" rx="6"/><path d="M54 38l15 13M54 82l15-13M126 60h15"/><text x="29" y="42">DateTime</text><text x="29" y="86">DateTime</text><text x="97" y="55">Later&lt;T&gt;</text><text x="97" y="70">T inferred</text><text x="159" y="64">Date</text></svg>`,
  ...
  closedgenerics:`<svg viewBox="0 0 180 120" role="img" aria-labelledby="d50t d50d"><title id="d50t">One open generic method serves two closed types</title><desc id="d50d">The single Later T definition branches into Later int for employee IDs and Later DateTime for clock-in timestamps.</desc><rect x="54" y="8" width="72" height="34" rx="7"/><rect x="5" y="72" width="72" height="36" rx="7"/><rect x="103" y="72" width="72" height="36" rx="7"/><path d="M75 43L42 71M105 43l33 28"/><text x="90" y="29">Later&lt;T&gt;</text><text x="41" y="87">Later&lt;int&gt;</text><text x="41" y="100">IDs</text><text x="139" y="87">Later&lt;DateTime&gt;</text><text x="139" y="100">ClockIn</text></svg>`,
